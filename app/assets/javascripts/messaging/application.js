...
var createConsumer = function(url = getConfig("url") || INTERNAL.default_mount_path) {
...
// app/javascript/controllers/messaging_controller.ts
class messaging_controller_default extends Controller {
  constructor() {
    super(...arguments);
  }
  ...
  connect() {
    ...
    const current_user = this.currentUserIdTarget;
...
//# debugId=E3973821CED9FB1764756e2164756e21
